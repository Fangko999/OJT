...
<head>
    ...
    <style>
        body {
            background-color: #f8f9fc; /* Màu nền nhẹ cho toàn bộ trang */
        }
        .card {
            background-color: #ffffff; /* Màu nền của card */
            border-radius: 8px; /* Bo góc card */
            box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); /* Đổ bóng nhẹ cho card */
        }
        .btn-primary {
            background-color: #4e73df; /* Màu nền của nút */
            border-color: #4e73df; /* Đường viền của nút */
        }
        .btn-primary:hover {
            background-color: #2e59d9; /* Màu nền của nút khi hover */
            border-color: #2653d4; /* Đường viền của nút khi hover */
        }
        .form-group {
            margin-bottom: 1.5rem; /* Khoảng cách dưới cho các trường */
        }
    </style>
</head>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <button onclick="window.history.back();" class="btn mt-4" 
                    ...
                    <div class="card mt-4">
                        <div class="card-body">
                        <h4 class="card-title mb-4 text-center font-weight-bold" style="color: black;">Thêm Nhân Viên Mới</h4>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="name" id="name" class="form-control" 
                                               placeholder="Tên người dùng" value="{{ old('name') }}" required>
