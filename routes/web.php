...
Route::middleware(['web', 'auth', 'checkRole:1'])->group(function () {
    ...
    Route::get('/get-users-by-department', [PayrollController::class, 'getUsersByDepartment']);
    ...
    Route::get('/getSubDepartments', [User_attendanceController::class, 'getSubDepartments'])->name('getSubDepartments');
});

// User routes
Route::middleware(['web', 'auth', 'checkRole:2,3'])->group(function () {
    Route::get('/users/{id}', [UserController::class, 'show'])->name('users.show');
    Route::post('/users/{id}/change-password', [UserController::class, 'UserchangePassword'])->name('users.changePassword');
    Route::post('/users/{id}/quick-update', [UserController::class, 'update'])->name('users.quickUpdate');
    // Attendance routes
